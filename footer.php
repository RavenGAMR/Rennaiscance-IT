<footer class="page-footer text-white py-4">
    <div class="container">
        <div class="footer-content d-flex flex-column flex-md-row justify-content-between align-items-start gap-4">
            ...
            <div class="footer-left">
                ...
                <div class="footer-address text-start">
                    ...
                    <p class="mb-0">2288 GM Rijswijk</p>
                </div>
            </div>
        </div>
    </div>
